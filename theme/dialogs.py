"""
Themed popups for mtools, ported from the DMX reference script.
...
class Themed_Dialog(tk.Toplevel):
...
def show_error(parent, title: str, message: str) -> None:
    Themed_Dialog(parent, title, message, buttons=["OK"])


def ask_yes_no(parent, title: str, message: str) -> bool:
    dlg = Themed_Dialog(parent, title, message, buttons=["Yes", "No"])
    return dlg.result == "Yes"


def ask_string(parent, title: str, message: str) -> str | None:
    dlg = Themed_Dialog(parent, title, message, buttons=["OK", "Cancel"], with_entry=True)
