"""
Monte Carlo Simulation -- not implemented yet.
"""

from theme.widgets import ComputeToolWindow

TOOL_NAME = "Monte Carlo Simulation"
TOOL_DESCRIPTION = "Physical modeling via Monte Carlo simulation (incl. SRIM-style). -- not implemented yet."
